        ...
        <div className='main'>
            <div className='mainDiv'>
                <ul>
                    ...
                    <dt>useStates Uses Array Destructuring</dt>
                    <dd>useState proves a state variable and set State functional</dd>
...
function StateExample() {
    ...
    return(
        <div>
            ...
            <br />
            <img style={{width: '100px', height: '100px'}} src='http://upload.wikimedia.org/wikipedia/commons/1/13/Facebook_like_thumb.png' onClick={e => setLikeNum(likeNum + 1)} />
            <span>{likeNum}</span>
            <br />
            <br />
