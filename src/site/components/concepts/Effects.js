        ...
        <div className='main'>
            <div className='mainDiv'>
                ...
                <ul>
                    ...
                    <li>Effects are used to trigger certain actions based upon changes to the componets.</li>
...
const SampleEffect = () => {
       ...
       let timer;
        if(timerRunning){
            timer = window.setTimeout(() =>{
                console.log('the time expried', Date.now()/1000);
    ...
    return(
        <div style={{border: '1px dashed black'}}>
            ...
            <button onClick={buttonHandler}>Click me to start effect in the console</button>
        </div>
